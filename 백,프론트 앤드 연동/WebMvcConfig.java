...
//WebMvcConfigurer
//스프링MVC동작을 커스터마이징 할 때 사용된다.
//스프링은 기본적으로 MVC동작을 설정해주지만 , 때로는 프로젝트 요수사항에 맞게 특정 기능을 추가하거나
...
//주요기능
	...
	public void addCorsMappings(CorsRegistry registry) {
		...
		registry.addMapping("/**")
				...
				// 서버에 다시 요청하지 않고 저장된 응답을 재사용
				.maxAge(MAX_AGE_SECS);
	}
	//인터셉터(Interceptors)추가
	//특정 HTTP요청이 컨트롤러에 도달하기 전 또는 후에 실행되며, 요청을 가로채어 로깅, 인증,권환 학인들의
	//작업을 수행 할 수 있다.
